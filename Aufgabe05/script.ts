...
for (let index: number = 0; index < overOnEar.length; index++) {
...
for (let index: number = 0; index < inEar.length; index++) {
    //Div
    let newDiv: HTMLElement = document.createElement("div");
...
for (let index: number = 0; index < boxen.length; index++) {
    //Div
    let newDiv: HTMLElement = document.createElement("div");
