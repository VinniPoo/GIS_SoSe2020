...
export namespace A08Server {
  ...
  function handleListen(): void { //die Funktion handleListen wird ausgeführt und soll keinen Rückgabewert haben
    console.log("Listening"); //Listening wird in der Konsole ausgegeben
  }

  function handleRequest(_request: Http.IncomingMessage, _response: Http.ServerResponse): void { //die Funktion handleRequest wird ausgeführt, mit den parametern _request und _response, sie soll keinen Rückgabewert haben.
    ...
    if (_request.url) {
      ...
      let abschnitt: string | null = url.pathname;
      if (abschnitt == "/html") {
